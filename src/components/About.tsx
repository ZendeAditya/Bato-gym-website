...
const About = () => {
  ...
  return (
    <section className="bg-[#1A1D24] w-auto h-[110vh] text-white">
      <div className="px-5 py-5 md:px-10 md:py-10 lg:px-24 lg:py-24 text-lg md:text-xl lg:text-2xl relative">
        ...
        <div>
          <h2 className="uppercase text-lg md:text-xl lg:text-4xl font-bold ">
            Your <span className="text-orange-500">Fitness </span> Journy start
            here!
          </h2>

          <p className="py-5 text-justify text-base">
            Unlock Your Fitness Potential at Our Gym At our gym, we believe that
            fitness is a journey, not a destination. {"That's "}why {"we're"}{" "}
            dedicated to providing a supportive and motivating environment for
            our members to reach their full potential. Our state-of-the-art
            facilities, expert trainers, and diverse range of group fitness
            classes and personal training programs are designed to help you
            achieve your fitness goals, whether {"you're"} a beginner or an
            experienced athlete. Our trainers are passionate about helping you
            succeed and will work with you to create a personalized fitness plan
            tailored to your needs and goals. Join our fitness community today
